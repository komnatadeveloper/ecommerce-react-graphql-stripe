...
//     try {
//       // create stripe token
//       const response = this.props.stripe.createToken();
...
//         token
//       });
//       // set order processing to false, set modal - false
...
// const Checkout = () => (
//   <StripeProvider apiKey="pk_test_FKH0zyP1EBiVAY6LSJizlCW700A6UH8gb9">
//     <Elements>
//       <CheckoutForm />
//     </Elements>
//   </StripeProvider>
